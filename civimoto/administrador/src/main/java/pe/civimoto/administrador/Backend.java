...
public class Backend {
    ...
    public Backend(Context c){prefs=c.getSharedPreferences("civimoto_admin_session_v1",Context.MODE_PRIVATE);supabaseUrl=prefs.getString("url",null);publishableKey=prefs.getString("key",null);accessToken=prefs.getString("access",null);refreshToken=prefs.getString("refresh",null);userId=prefs.getString("uid",null);role=prefs.getString("role",null);expiresAtMs=prefs.getLong("expires",0L);}
