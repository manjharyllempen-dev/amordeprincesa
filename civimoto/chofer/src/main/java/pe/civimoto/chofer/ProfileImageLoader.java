...
public class ProfileImageLoader {
    ...
    public void download(String path,Backend.Callback cb){io.execute(()->{try{
        ...
        c.setConnectTimeout(15000);c.setReadTimeout(25000);c.setRequestMethod("GET");c.setRequestProperty("apikey",backend.getPublishableKey());c.setRequestProperty("Authorization","Bearer "+backend.getAccessToken());
